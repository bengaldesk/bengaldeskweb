      ...
      <main className='flex-1 container mx-auto px-4 py-8 max-w-5xl'>
        ...
        <section className="mb-12">
          ...
          <div className="max-w-none text-text-secondary leading-relaxed space-y-4">
            <p className="mb-4">
              The Bengal Desk একটি আধুনিক ও গতিশীল বাংলা নিউজ পোর্টাল। আমরা বাংলাদেশ ও বিশ্বের সর্বশেষ সংবাদ, গভীর বিশ্লেষণ এবং নিরপেক্ষ দৃষ্টিভঙ্গি নিয়ে পাঠকদের সামনে হাজির হই। সত্যের পথে অবিচল থেকে বস্তুনিষ্ঠ সাংবাদিকতা আমাদের মূল লক্ষ্য।
            </p>
            <p className="mb-4">
              ২০২৪ সালে যাত্রা শুরু করা The Bengal Desk খুব অল্প সময়েই পাঠকদের বিশ্বস্ততা অর্জন করতে সক্ষম হয়েছে। রাজনীতি, অর্থনীতি, আন্তর্জাতিক, খেলাধুলা, বিনোদন, প্রযুক্তি এবং লাইফস্টাইল সহ সব ধরণের সংবাদ আমরা দ্রুত এবং নির্ভুলভাবে পৌঁছে দেই।
            </p>
          </div>
        </section>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground">
                আমরা বিশ্বাস করি, একটি স্বাধীন ও শক্তিশালী গণমাধ্যম গণতন্ত্রের মূল ভিত্তি। The Bengal Desk কোনো রাজনৈতিক বা গোষ্ঠীগত স্বার্থের ঊর্ধ্বে থেকে শুধুমাত্র জনস্বার্থে কাজ করে।
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4 p-4 border rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">info@bengaldesk.com</p>
              </div>
            </div>
          </div>
        </section>
