    ...
    <div className='flex min-h-screen flex-col bg-background'>
      ...
      <main className='flex-1 container mx-auto px-4 py-8 max-w-5xl'>
        ...
        <section className="mb-12">
          <h1 className="text-4xl font-bold font-serif-bn mb-6 text-brand">আমাদের সম্পর্কে</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <Card>
            <CardContent className="pt-6">
              <h2 className="text-2xl font-bold font-serif-bn mb-4">আমাদের লক্ষ্য</h2>
          ...
          <Card>
            <CardContent className="pt-6">
              <h2 className="text-2xl font-bold font-serif-bn mb-4">আমাদের দর্শন</h2>
              <p className="text-muted-foreground">
        ...
        <section className="bg-secondary/30 rounded-xl p-8 mb-12">
          <h2 className="text-3xl font-bold font-serif-bn mb-6 text-center">কেন আমরা অনন্য?</h2>
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold font-serif-bn mb-6">আমাদের সাথে যোগাযোগ করুন</h2>
