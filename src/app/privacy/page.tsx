    ...
    <div className='flex min-h-screen flex-col bg-background'>
      ...
      <main className='flex-1 container mx-auto px-4 py-8 max-w-4xl'>
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold font-serif-bn mb-6">গোপনীয়তা নীতি (Privacy Policy)</h1>
          <p className="text-muted-foreground mb-6">সর্বশেষ আপডেট: ৪ আগস্ট, ২০২৪</p>
          
          <p>
            বার্তা নিউজ পোর্টালে আপনার গোপনীয়তা রক্ষা করা আমাদের কাছে অত্যন্ত গুরুত্বপূর্ণ। এই গোপনীয়তা নীতি আমাদের পাঠকদের তথ্যের সুরক্ষা এবং আমরা কীভাবে সেই তথ্য ব্যবহার করি সে সম্পর্কে বিস্তারিত ধারণা প্রদান করে।
          </p>
          ...
          <p>
            বার্তা কর্তৃপক্ষ যেকোনো সময় এই গোপনীয়তা নীতি পরিবর্তন বা পরিমার্জন করার অধিকার রাখে। যেকোনো পরিবর্তন এই পৃষ্ঠায় জানানো হবে।
          </p>

          <h2 className="text-xl font-bold mt-8 mb-4">যোগাযোগ</h2>
          <p>
            গোপনীয়তা নীতি সম্পর্কে আপনার কোনো প্রশ্ন থাকলে আমাদের ইমেইল করুন: <a href="mailto:privacy@barta.news" className="text-brand hover:underline">privacy@barta.news</a>
          </p>
        </article>
      </main>
