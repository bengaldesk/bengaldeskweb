    ...
    <div className='flex min-h-screen flex-col bg-background'>
      ...
      <main className='flex-1 container mx-auto px-4 py-8 max-w-4xl'>
        ...
        <article className="max-w-none space-y-6 text-text-secondary leading-relaxed">
          ...
          <p>
            The Bengal Desk নিউজ পোর্টালে আপনাকে স্বাগতম। এই ওয়েবসাইট ব্যবহার করার মাধ্যমে আপনি নিম্নলিখিত শর্তাবলী মেনে নিতে সম্মত হচ্ছেন। অনুগ্রহ করে শর্তগুলো মনোযোগ সহকারে পড়ুন।
          </p>

          <h2 className="text-xl font-bold mt-8 mb-4">১. বৌদ্ধিক সম্পত্তি (Intellectual Property)</h2>
          <p>
            The Bengal Desk-এপ্রকাশিত সমস্ত সংবাদ, ছবি, ভিডিও, লোগো এবং ডিজাইন The Bengal Desk কর্তৃপক্ষের নিজস্ব সম্পত্তি অথবা যথাযথ অনুমতি সাপেক্ষে ব্যবহৃত। আমাদের লিখিত অনুমতি ছাড়া কোনো বিষয়বস্তু বাণিজ্যিক উদ্দেশ্যে কপি, পুনরুৎপাদন বা বিতরণ করা আইনত দণ্ডনীয়।
          </p>
          ...
          <p>
            আমরা সবসময় সঠিক তথ্য প্রদানের চেষ্টা করি, তবে তথ্যের সম্পূর্ণ নির্ভুলতা বা সাময়িক ত্রুটির জন্য The Bengal Desk কর্তৃপক্ষ দায়ী থাকবে না। সাইটের কোনো লিঙ্কের মাধ্যমে অন্য কোনো থার্ড-পার্টি ওয়েবসাইটে গেলে তার বিষয়বস্তুর জন্য আমরা দায়ী নই।
          </p>

          <h2 className="text-xl font-bold mt-8 mb-4">৪. সেবা পরিবর্তন</h2>
          <p>
            The Bengal Desk কর্তৃপক্ষ যেকোনো সময় পূর্ব ঘোষণা ছাড়াই ওয়েবসাইটের কোনো অংশ পরিবর্তন, পরিবর্ধন বা বন্ধ করার অধিকার রাখে।
          </p>
