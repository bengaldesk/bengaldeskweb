    ...
    <div className='flex min-h-screen flex-col bg-background'>
      ...
      <main className='flex-1 container mx-auto px-4 py-8 max-w-4xl'>
        ...
        <article className="max-w-none space-y-6 text-text-secondary leading-relaxed">
          ...
          <p>
            The Bengal Desk নিউজ পোর্টালে আপনার অভিজ্ঞতা উন্নত করতে আমরা 'কুকিজ' ব্যবহার করি। এই নীতিমালায় কুকিজ কী, আমরা কেন এটি ব্যবহার করি এবং আপনি কীভাবে এটি নিয়ন্ত্রণ করতে পারেন তা ব্যাখ্যা করা হয়েছে।
          </p>
