...
import { getAuthorSlug } from '@/lib/posts'
...
/**
 * AuthorBioCard — NYT/Guardian-style author card.
 * Card with top accent bar, clean layout, professional feel.
 */
    ...
    <div className='author-bio-card'>
      <div className='flex gap-4 sm:gap-5'>
        ...
        <div className='min-w-0 flex-1 pt-0.5'>
          ...
          {role && (
            <p className='mt-0.5 text-xs font-medium text-muted-foreground'>{role}</p>
          )}
          {bio && (
